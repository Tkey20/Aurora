    ...
    <header class="header-content">
      <el-row>
        <el-col :span="7" class="header-title">
          <router-link to="/" class="name" :class="{ active: headerColor }"
            >Aurora</router-link
          >
        ...
        <el-col :span="8" class="publish-text">
          <a
            href="https://vikeya.com/"
            target="_blank"
            class="header-title"
            :class="{ active: headerColor }"
          >
            我的博客
          </a>
          <a
            href="https://github.com/Tkey20"
            target="_blank"
            class="header-title"
            :class="{ active: headerColor }"
          >
...
import {
  swiperAnimateCache,
  swiperAnimate
} from "@assets/styles/swiper.animate1.0.3";
